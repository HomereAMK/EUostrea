...
# Bams file
bams=read.table("Data/PCA/SanityCheck_chr1_EUostrea/bamlist_EUostrea_replicates.txt")[,1] # list of bam files
bams0=bams
...
pcc = as.matrix(read.table("Data/PCA/SanityCheck_chr1_EUostrea/SC_chr1_Tyler_minMapQ20_minInd0.25_setMinDepthInd1_setMinDepth7_rmTriallelic0.05minMaf0.05__setMaxDepth20000_SNPpval1e-6_minMaf0.05_nov22.covMat"))
dimnames(pcc)=list(indivi,indivi)
pccd=1-cov2cor(pcc)

# reading the ibs matrix
ma = as.matrix(read.table("Data/PCA/SanityCheck_chr1_EUostrea/SC_chr1_Tyler_minMapQ20_minInd0.25_setMinDepthInd1_setMinDepth7_rmTriallelic0.05minMaf0.05__setMaxDepth20000_SNPpval1e-6_minMaf0.05_nov22.ibsMat"))
...
pdf(file = "~/Desktop/Scripts/EUostrea/Figures/SanityCheck/DendrocovMat_SC_chr1_Tyler_minMapQ20_minInd0.25_setMinDepthInd1_setMinDepth7_rmTriallelic0.05minMaf0.05__setMaxDepth20000_SNPpval1e-6_minMaf0.05_nov22.pdf",   # The directory you want to save the file in
    width = 40, # The width of the plot in inches
    height = 10 )
hc=hclust(as.dist(ma),"ave")
plot(hc,cex=0.3) # clustering of samples by IBS 
dev.off()
pdf(file = "~/Desktop/Scripts/EUostrea/Figures/SanityCheck/DendroIbsMat_SC_chr1_Tyler_minMapQ20_minInd0.25_setMinDepthInd1_setMinDepth7_rmTriallelic0.05minMaf0.05__setMaxDepth20000_SNPpval1e-6_minMaf0.05_nov22.pdf",   # The directory you want to save the file in
    width = 40, # The width of the plot in inches
    height = 10 )
...
cov_mat <- as.matrix(read.table("~/Desktop/Scripts/Data/PCA/SanityCheck_chr1_EUostrea/SC_chr1_Tyler_minMapQ20_minInd0.25_setMinDepthInd1_setMinDepth7_rmTriallelic0.05minMaf0.05__setMaxDepth20000_SNPpval1e-6_minMaf0.05_nov22.covMat")) 
...
SC_chr1_pca <- PCA(cov_mat, annot$V1, annot$V2, 1, 2, show.ellipse = F)
ggsave(SC_chr1_pca, file = "~/Desktop/Scripts/EUostrea/Figures/SanityCheck/PCA_SC_chr1_Tyler_minMapQ20_minInd0.25_setMinDepthInd1_setMinDepth7_rmTriallelic0.05minMaf0.05__setMaxDepth20000_SNPpval1e-6_minMaf0.05_nov22.pdf", device = cairo_pdf, scale = 1.1, width = 12, height = 8, dpi = 300)
dev.off()
